...
class Storage {//필요한 정보를 미리 받아 저장하는 클래스
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            FutureBuilder(//이 부분에서 불러온 데이터를 출력할 예정이었으나, 공지를 불러오는 중간 과정을 볼 수 없어 성공/실패 여부를 알 수 없음
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  // 데이터를 정상적으로 받아오게 되면 다음 부분을 실행하게 되는 부분
                    ...
                    return Padding(
                      ...
                      child: Text(
                        context.toString(), // 비동기 처리를 통해 받은 데이터를 텍스트에 뿌려줌
                        style: TextStyle(fontSize: 15),
                      ),
                    );
                  }
            ...
            children: <Widget>[
              ...
              Positioned(
                child: OutlinedButton(
                  onPressed: () {
                    scraper_1 = CNUCyberCampusScraper(value1.toString(), value2.toString());
